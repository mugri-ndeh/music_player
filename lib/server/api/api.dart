class Api {
  static const String api = "https://app.excite-digital.co.uk/";
  static const String login_api = api + "api/login_api.php";
  static const String signup_api = api + "api/signup_api.php";
